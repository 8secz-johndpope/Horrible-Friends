...
public class login_email_activ extends AppCompatActivity {

    private static final String TAG = "login_email_activ";
    ...
    ImageButton verify_phone_button;
   ...
   // int initial_child_count=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_email_activ);
        parentLayout = findViewById(android.R.id.content);
        back_view = findViewById(R.id.back_login_active);
        login_email = findViewById(R.id.login_email_edit_text);
        login_password = findViewById(R.id.login_password_edit_text);
        forgot_pass_button= findViewById(R.id.forgot_password_button_active_login);
        email_login_button = findViewById(R.id.login_button_active);
        facebook_login_custom = findViewById(R.id.facebook_login_button_custom_two);
        twitter_login_button_custom =findViewById(R.id.twitter_login_button_custom_two);
        verify_phone_button = findViewById(R.id.phone_login_custom_two);
        my_back_view= findViewById(R.id.imageView7_back_login_email_activ);
        myBar = findViewById(R.id.progress_bar_login_cur_activity);
...
*/
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    if (AccessToken.getCurrentAccessToken() != null) {
                        ...
                        isFacebook = true;
                        LoginManager.getInstance().logInWithReadPermissions(login_email_activ.this, Arrays.asList("public_profile", "email", "user_friends"));
        ...
        */
        ...
        twitter_login_button_custom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    twitterAuthClient.authorize(login_email_activ.this, new Callback<TwitterSession>() {
                        @Override
        ...
        forgot_pass_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(login_email_activ.this, forgot_password_activity.class);
                startActivity(i);
            }
        });
                                            ...
                                            auth_ref.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(DataSnapshot dataSnapshot) {
                                                    ...
                                                    if (dataSnapshot.hasChild(mAuth.getCurrentUser().getUid())) {
                                                        error_bar();
                                                        Intent i = new Intent(login_email_activ.this, home_activity.class);
                                                        startActivity(i);
                                                    } else {
                                                        ...
                                                        databaseReference.child("users_auth").addListenerForSingleValueEvent(new ValueEventListener() {
                                                            ...
                                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                                ...
                                                                if (dataSnapshot.hasChild(mAuth.getCurrentUser().getUid())&& dataSnapshot.child(mAuth.getCurrentUser().getUid()).hasChild("is_suspended"))
                                                                {
                                                                    ...
                                                                    // change required
                                                                    error_bar();
                                                                    Intent i = new Intent(login_email_activ.this, Main3Activity.class);
                                                                    startActivity(i);
                                                                }
                                                            }
                                    ...
                                    else if (dsp.getKey().equals("phone"))
                                    {
                                        ...
                                        if (twitter_child_check) {
                                            if (!dsp.getValue().equals("twitter")) {
                                                error_bar();
                                                show_snackbar(getResources().getString(R.string.cant_login_your_acc_signed_up_with) + dsp.getValue(),true);
...
/*
        ...
        */
                                                ...
                                                mAuth.signInWithCredential(credential)
                                                        .addOnCompleteListener(login_email_activ.this, new OnCompleteListener<AuthResult>() {
                                                            @Override
                                                            public void onComplete(@NonNull Task<AuthResult> task) {
                                                                if (task.isSuccessful()) {
                            ...
                            */
                                    ...
                                    */
                                                                    ...
                                                                    Toast.makeText(login_email_activ.this, getResources().getString(R.string.auth_failed),
                                                                            Toast.LENGTH_SHORT).show();
        ...
        */
                            ...
                            */
                                    ...
                                    */
                                                                    ...
                                                                    Toast.makeText(getApplicationContext(), getResources().getString(R.string.cant_retrieve_email_twitter_chooose_another_mehtod),Toast.LENGTH_SHORT).show();
                                                                    error_bar();
                                                                }
                                                                // Sign in success, update UI with the signed-in user's information
                    ...
                    @Override
                    public void onCancelled(DatabaseError databaseError) {
                       // Toast.makeText(getApplicationContext(), "Couldn't retrieve data from data base!",Toast.LENGTH_SHORT).show();
                        error_bar();
...
/*
            ...
            public void failure(TwitterException exception) {
                Toast.makeText(getApplicationContext(), getResources().getString(R.string.error_with_twitter),Toast.LENGTH_SHORT).show();
                error_bar();
...
*/        ///////////////////////////////////////////////////////////////// new logic ///////////////////////////////////////////////////////////////////////
                              ...
                              */
                               ...
                               */
                                ...
                                @Override
                                public void onCancelled(DatabaseError databaseError) {
                                 //   Toast.makeText(getApplicationContext(), "Couldn't retrieve data from database!",Toast.LENGTH_SHORT).show();
                                    error_bar();
            ...
            auth_ref.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.hasChild(mAuth.getCurrentUser().getUid()))
                    {
                        ...
                        error_bar();
                        mAuth.signOut();
                        Toast.makeText(getApplicationContext(),"No record found, Sign up!",Toast.LENGTH_SHORT).show();
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                if (task.isSuccessful()) {
                                                    ...
                                                    if (type_to_db.equals("email")) {
                                                        ...
                                                        Intent i = new Intent(login_email_activ.this, Main2Activity.class);
                                                        startActivity(i);
                                                    }
                                                    else {
                                                        Intent i = new Intent(login_email_activ.this, Main3Activity.class);
...
error_bar();
    ...
    public void phoneLogin() {
        final Intent intent = new Intent(login_email_activ.this, AccountKitActivity.class);
                ...
                .addOnCompleteListener(login_email_activ.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(login_email_activ.this, "Authentication failed.",
                                    Toast.LENGTH_SHORT).show();
                        }
    ...
    public void show_snackbar(String txt, Boolean length)
    {
        if (parentLayout!=null) {
            ...
            mView.setBackgroundColor(ContextCompat.getColor(login_email_activ.this, R.color.colorPrimaryDark));
            TextView mTextView = mView.findViewById(android.support.design.R.id.snackbar_text);
            mTextView.setTextColor(ContextCompat.getColor(login_email_activ.this, R.color.white));
    ...
    public void error_bar()
    {
        ...
        my_back_view.setVisibility(View.VISIBLE);
    ...
    public void start_bar()
    {
       back_view.setVisibility(View.INVISIBLE);
        my_back_view.setVisibility(View.INVISIBLE);
